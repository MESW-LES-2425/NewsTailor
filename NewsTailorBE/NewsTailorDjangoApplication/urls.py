...
from .connections.newspaper_utils_view import ObtainNewsPaperByIdView, DeleteNewsPaperByIdView, SaveNewsPaperByIdView, ObtainUserNewsPapersView, DeleteNewsPaperIfNotSavedView, ReadNewsPaperByIdView
